...
5. **Добавьте процедуры регистрации и аутентификации по логину и паролю**
6. **Убедитесь, что все операции работают правильно и все доступы выдаются согласно настройкам**
