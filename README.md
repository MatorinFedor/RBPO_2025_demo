...
6. **Подготовьте почву для аутентификации по логину и паролю (пока мы используем BasicAuth она нам отдельно не требуется, но в будущем понадобится)**
7. **Убедитесь, что все операции работают правильно и все доступы выдаются согласно настройкам**
